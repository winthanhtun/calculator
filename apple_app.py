...
with st.container():
    ...
    with col1:
        f1_s = st.date_input("အချုပ်တွင်ပြစ်ဒဏ်စတင်ကျခံသည့်ရက်စွဲ", datetime(2024, 12, 20), key="f1s")
        f1_e = st.date_input("	အချုပ်တွင်ပြစ်ဒဏ်ကျခံမှု ပြီးဆုံးသည့်ရက်စွဲ", datetime(2025, 6, 30), key="f1e")
    with col2:
        f2_s = st.date_input("‌ထောင်တွင်ပြစ်ဒဏ်စတင်ကျခံသည့်ရက်စွဲ", datetime(2025, 7, 1), key="f2s")
        f2_e = st.date_input("‌ထောင်တွင်ပြစ်ဒဏ်ကျခံမှု ပြီးဆုံးသည့်ရက်စွဲ", datetime(2026, 1, 17), key="f2e")
    with col3:
        f3_s = st.date_input("ရဲဘက်စခန်းတွင် ပြစ်ဒဏ်စတင်ကျခံသည့် ရက်စွဲ", datetime(2026, 1, 18), key="f3s")
        f3_e = st.date_input("ရဲဘက်စခန်းတွင် ပြစ်ဒဏ်ကျခံမှု ပြီးဆုံးသည့်ရက်စွဲ", datetime(2026, 4, 23), key="f3e")
